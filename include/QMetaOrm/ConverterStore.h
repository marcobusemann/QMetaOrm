...
namespace QMetaOrm {
   ...
   */
   ...
   public:
      virtual ~ConverterStore() {}
      virtual void registerConverter(const QString &name, const Converter::Ptr &converter) = 0;
   ...
   */
   ...
   public:
      virtual void registerConverter(const QString &name, const Converter::Ptr &converter) override;
