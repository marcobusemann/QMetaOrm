...
QormPropertyPrefixer::Handler QormPropertyPrefixer::getRecordValuePrefixer(const QSqlRecord & record, const QString & prefixString)
{
...
QormPropertyPrefixer::Handler QormPropertyPrefixer::getEmbeddedRecordValuePrefixer(Handler prefixer, const QString & prefix)
{
