...
QormDefaultSessionFactory::QormDefaultSessionFactory(const QormDatabaseFactory::Ptr &databaseFactory, const QormLogger::Ptr &logger, const QormEntityCacheFactory::Ptr &cacheFactory)
   : m_databaseFactory(databaseFactory)
   , m_converterStore(QormDefaultConverterStore::factory())
   , m_logger(logger)
...
QormSessionFactory::Ptr QormDefaultSessionFactory::factory(const QormDatabaseFactory::Ptr &databaseFactory, const QormLogger::Ptr &logger, const QormEntityCacheFactory::Ptr &cacheFactory) {
